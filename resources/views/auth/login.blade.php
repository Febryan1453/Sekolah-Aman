...
<head>
    <meta charset="utf-8">
    <title>Login to Sistem</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="{{url('dashmin/img/idn.png')}}" rel="icon">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <!-- <div class="d-flex align-items-center justify-content-center mb-3">
                            <img src="{{url('dashmin/img/idn.png')}}" width="70px" alt="Logo Idn">
                        </div> -->
                        <div class="d-flex align-items-left" style="margin-top: -10px;">
                            <p><a href="{{route('front')}}"><i class="fa-solid fa-circle-chevron-left"></i> Back</a></p>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-3">
                            <h4>Sign In</h4>
                        </div>
