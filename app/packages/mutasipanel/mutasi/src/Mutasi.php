...
namespace MutasiPanel\Mutasi;

class Mutasi
{
	private $api_url = 'https://app.mutasi.co.id/api';
	private $api_token = 'QXVF73HajpI84s2yurDCtNqwEgcAkhvRYonil6Ub';
	private $serverIpAddress = '107.152.46.70';
